...
white_corr = white_wine.corr()['quality'][0:-1]
...
plt.text(-0.7, 13.5, 'Wine Quality Most Strongly Correlated With Alcohol Level', weight = 'bold')
plt.text(-0.7, 12.7, 'Correlation values between wine quality and wine properties (alcohol, pH, etc.)')
plt.show()
